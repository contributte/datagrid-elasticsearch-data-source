...
coverage-clover:
	vendor/bin/tester tests/Cases -s -p phpdbg --colors 1 -C --coverage ./coverage.xml --coverage-src ./src tests

coverage-html:
	vendor/bin/tester tests/Cases -s -p phpdbg --colors 1 -C --coverage ./coverage.html --coverage-src ./src tests
